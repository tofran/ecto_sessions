defmodule EctoSessions.AuthToken do
  ...
  Returning a tuple `{plain_auth_token, hashed_auth_token}`.
  """
  def get_auth_tokens do
    plain_auth_token = generate()

    {plain_auth_token, hash(plain_auth_token)}
  end
  ...
  def add_salt(auth_token), do:
    add_salt(auth_token, Config.get_hashing_secret_salt())
